...
/**
 * Holds information about bulk composition, molalities, etc of the user-defined geochemical system
 */
...
private:
  ...
  /// maximum allowed value of ionic strength
  ...
  /**
   * Compute the ionic strength and stoichiometric ionic strength
   */
  void computeIonicStrengths(Real & ionic_strength, Real & stoichiometric_ionic_strength) const;
  ...
  /**
   * Calculate all relevant activity coefficients (ie, not minerals, gases, water, or basis species
   * that have been provided with an activity by the user)
   */
  void buildActivityCoefficients(std::vector<Real> & basis_activity_coef,
