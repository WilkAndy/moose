...
EquilibriumGeochemicalSystem::EquilibriumGeochemicalSystem(
  ...
  : _mgd(mgd),
    ...
    _gac(GeochemistryActivityCoefficients::ActivityCoefficientMethodEnum::DEBYE_HUCKEL,
         max_ionic_strength,
         max_ionic_strength,
...
{
  _gac.setMaxIonicStrength(max_is);
  _gac.setMaxStoichiometricIonicStrength(max_is);
}

Real
EquilibriumGeochemicalSystem::getMaxIonicStrength() const
{
  return _gac.getMaxIonicStrength();
}
